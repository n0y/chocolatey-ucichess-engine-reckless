...
$FileUrl = "https://github.com/codedeliveryservice/Reckless/releases/download/v$UpstreamVersion/reckless-windows-avx2.exe"
...
(Get-Content .\src\ucichess-engine-reckless.template.nuspec.xml) -replace '%%VERSION%%', $UpstreamVersion | Out-File -Encoding utf8 ".\target\ucichess-engine-reckless.nuspec"
